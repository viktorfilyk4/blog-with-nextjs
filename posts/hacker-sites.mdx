...
<Note>
  djhkfskdfkhjsdhkjfhsdjfhdskjhfjksdhfkjsdhfh sdjfhsdjkfhjsdhfhsdkjfhsdfs sdjfhskjhahfjkfjfhkfg
  fdjghdfjghsgjkhrueghj
</Note>
...
<details className='dark:not-prose rounded-2xl border border-solid bg-gray-200 p-4 hover:cursor-pointer'>
  <summary>Title</summary>
  <div>```js console.log('heellow orld'); ```</div>
</details>
